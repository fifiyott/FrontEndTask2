                ...
                <div className={styles['flex-container']} >
                    <div className={styles['flex-content1']}>
                        <div className={styles['img-kiri']} >
                            <Image src="/Puma-ab.jpg" alt="Puma" width="600" height="700"/>
                        </div>
                    ...
                    <div className={styles['flex-content2']}>                        
                        ...
                        <div className={styles['img-kanan']} >
                            <Image src="/Puma-in.jpg" alt="Puma" width="500" height="700"/>
                        </div>
                    </div>

                    <div className={styles['flex-content3']}>
                        <div className={styles['img-kiri']} >
                            <Image src="/Puma-team.jpg" alt="Puma" width="600" height="700"/>
                        </div>
